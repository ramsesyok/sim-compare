...
pub fn emit_timeline_log(
    ...
    for &entity in entities {
        let id = world.get::<&crate::sim::Id>(entity)?;
        let team_id = world.get::<&crate::sim::TeamId>(entity)?;
        let role = world.get::<&Role>(entity)?;
        let position = world.get::<&crate::geo::Ecef>(entity)?;
